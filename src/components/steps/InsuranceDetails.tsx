    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div>
              <label htmlFor="policyHolder.firstName" className="block text-sm font-medium text-gray-700">
                First Name
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="policyHolder.lastName" className="block text-sm font-medium text-gray-700">
                Last Name
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="policyHolder.dateOfBirth" className="block text-sm font-medium text-gray-700">
                Date of Birth
              </label>
              <input
                type="date"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div>
              <label htmlFor="company.contactName" className="block text-sm font-medium text-gray-700">
                Contact Name
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="company.contactTitle" className="block text-sm font-medium text-gray-700">
                Contact Title
              </label>
              <input
                type="text"
            ...
            <div className="sm:col-span-2">
              <label htmlFor="company.address1" className="block text-sm font-medium text-gray-700">
                Address Line 1
              </label>
              <input
                type="text"
            ...
            <div className="sm:col-span-2">
              <label htmlFor="company.address2" className="block text-sm font-medium text-gray-700">
                Address Line 2
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="company.zip" className="block text-sm font-medium text-gray-700">
                ZIP Code
              </label>
              <input
                type="text"
